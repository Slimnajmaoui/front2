...
@Component({
  selector: 'app-chefdeprojetindexchefdeprojet',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule,UserfooterComponent,UserheaderComponent,UsermenuComponent],
  templateUrl: './chefdeprojetindexchefdeprojet.component.html',
  styleUrl: './chefdeprojetindexchefdeprojet.component.css'
})
export class ChefdeprojetindexchefdeprojetComponent {

...
@Component({
  selector: 'app-chefdeprojeteditafftache',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule,UserfooterComponent,UserheaderComponent,UsermenuComponent],
  templateUrl: './chefdeprojeteditafftache.component.html',
  styleUrl: './chefdeprojeteditafftache.component.css'
})
export class ChefdeprojeteditafftacheComponent {

...
@Component({
  selector: 'app-chefdeprojetviewaffgroupe',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule,UserfooterComponent,UserheaderComponent,UsermenuComponent],
  templateUrl: './chefdeprojetviewaffgroupe.component.html',
  styleUrl: './chefdeprojetviewaffgroupe.component.css'
})
export class ChefdeprojetviewaffgroupeComponent {

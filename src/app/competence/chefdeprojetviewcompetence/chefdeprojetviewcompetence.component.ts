...
@Component({
  ...
  templateUrl: './chefdeprojetviewcompetence.component.html',
  styleUrl: './chefdeprojetviewcompetence.component.css'
})
export class ChefdeprojetviewcompetenceComponent {

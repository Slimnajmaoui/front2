...
@Component({
  selector: 'app-chefdeprojetcreateavtache',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule,UserfooterComponent,UserheaderComponent,UsermenuComponent],
  templateUrl: './chefdeprojetcreateavtache.component.html',
  styleUrl: './chefdeprojetcreateavtache.component.css'
})
export class ChefdeprojetcreateavtacheComponent {

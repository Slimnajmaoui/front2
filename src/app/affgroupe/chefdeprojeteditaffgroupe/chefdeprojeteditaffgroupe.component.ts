...
@Component({
  selector: 'app-chefdeprojeteditaffgroupe',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule,UserfooterComponent,UserheaderComponent,UsermenuComponent],
  templateUrl: './chefdeprojeteditaffgroupe.component.html',
  styleUrl: './chefdeprojeteditaffgroupe.component.css'
})
export class ChefdeprojeteditaffgroupeComponent {

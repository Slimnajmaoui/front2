...
@Component({
  selector: 'app-chefdeprojetindexavtache',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule,UserfooterComponent,UserheaderComponent,UsermenuComponent],
  templateUrl: './chefdeprojetindexavtache.component.html',
  styleUrl: './chefdeprojetindexavtache.component.css'
})
export class ChefdeprojetindexavtacheComponent {

...
@Component({
  selector: 'app-chefdeprojeteditprojet',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule,UserfooterComponent,UserheaderComponent,UsermenuComponent],
  templateUrl: './chefdeprojeteditprojet.component.html',
  styleUrl: './chefdeprojeteditprojet.component.css'
})
export class ChefdeprojeteditprojetComponent {
  id!: number;
  projet!: Projet;
  form!: FormGroup;

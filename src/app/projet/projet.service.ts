...
export class ProjetService {
  ...
  create(projet:Projet): Observable<any> {
    ...
    return this.httpClient.post(this.apiURL + '/Projets', JSON.stringify(projet), this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }  
  ...
  update(id:number, projet:any): Observable <any>{
    ...
    return this.httpClient.put(this.apiURL + '/Projets?id='+id, JSON.stringify(projet), this.httpOptions)
    .pipe( 
      catchError(this.errorHandler)
    )
  }

...
export class AdminService {
  ...
  create(admin:Admin): Observable<any> {
    ...
    return this.httpClient.post(this.apiURL + '/Users?profil="Admin"', JSON.stringify(admin), this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }  
  ...
  find(id:number): Observable <any>{
    ...
    return this.httpClient.get(this.apiURL + '/Userbyprofil?profil="Admin' + id)
    .pipe(
      catchError(this.errorHandler)
    )
  }
